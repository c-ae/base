...
def possible_cores_for_line(line, var_types):
    ...
    if line['op'] == '*':
        if line['type'] == 'uint64_t' and '0x13' in line['args']: # * 19 can be either imul r64/r64/i, or two lea; we skip the second case because REDACTED can't figure out what cost to use for it
            return ({
